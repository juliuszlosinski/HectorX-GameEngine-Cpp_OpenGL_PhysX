...
We can do something similar, but without casting light rays. Instead, we can use **the depth buffer**. Value in the depth buffer corresponds to the depth of a fragment which is value in [0, 1].
